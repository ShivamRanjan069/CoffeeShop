...
import pasty1 from "../assets/pasty-1.png"
import pasty2 from "../assets/pasty-2.png"
import pasty3 from "../assets/pasty-3.png"
import pasty4 from "../assets/pasty-4.png"
import pasty5 from "../assets/pasty-5.png"
  ...
  return (
    ...
    <div className="flex items-center justify-start w-full h-full gap-6 py-4 lg:px-14  mx-auto lg:overflow-hidden  lg:gap-[15px]">
      <div className="relative flex flex-shrink-0 w-20 sm:w-auto">
        <img src={pasty1} alt="" className="lg:w-60" />
      </div>
      <div className="relative flex flex-shrink-0 w-20 sm:w-auto">
        <img src={pasty2} alt="" className="lg:w-60" />
      </div>
      <div className="relative flex flex-shrink-0 w-20 sm:w-auto">
        <img src={pasty3} alt="" className="lg:w-60" />
      </div>
      <div className="relative flex flex-shrink-0 w-20 sm:w-auto">
        <img src={pasty4} alt="" className="lg:w-60" />
      </div>
      <div className="relative flex flex-shrink-0 w-20 sm:w-auto">
        <img src={pasty5} alt="" className="lg:w-60" />
      </div>
    </div>
    <button
